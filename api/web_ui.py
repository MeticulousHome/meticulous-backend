...
WEB_UI_HANDLER = [
        ...
        (r'/graph', tornado.web.RedirectHandler, {"url":"/graph.html"}),
        (r'/debug', tornado.web.RedirectHandler, {"url":"/debug.html"}),
        (r'/(.*)', tornado.web.StaticFileHandler, {"default_filename": "index.html","path": os.path.dirname(__file__)+"/web_ui"}),
        (r"/debug/send_data", SendDataHandler),
        (r"/debug/speaker_command", SpeakerCommandHandler),
        (r"/debug/program_esp32", ProgramESP32Handler),
        (r"/debug/set_time", SetTimeHandler),
        (r"/debug/get_time", GetTimeHandler),
        (r"/debug/gpio_status", GPIOStatusHandler),
    ]
