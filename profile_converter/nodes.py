...
if __name__ == "__main__":
    ...
    trigger = PressureCurveTrigger(SourceType.AVERAGE, TriggerOperatorType.GREATER_THAN_OR_EQUAL, 1,4)
    node_2.add_trigger(trigger)
    
    trigger = TemperatureValueTrigger(TemperatureSourceType.WATER, TriggerOperatorType.GREATER_THAN, 10, 3)
    node_2.add_trigger(trigger)
