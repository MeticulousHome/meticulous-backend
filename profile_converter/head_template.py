...
class HeadProfile:
    ...
    def purge_stage(self):
        ...
        self.piston_position_purge = PistonPositionTrigger(TriggerOperatorType.GREATER_THAN_OR_EQUAL, 78, 0, 45)
        self.piston_position_1_purge = PistonPositionTrigger(TriggerOperatorType.LESS_THAN, 78, 0, 6)
        self.button_trigger_purge = ButtonTrigger(ButtonSourceType.ENCODER_BUTTON, next_node_id = 45)
        ...
        self.move_piston_purge = SpeedController(SpeedAlgorithmType.EASE_IN, 6, DirectionType.FORWARD)
        self.pressure_trigger_purge = PressureValueTrigger(SourceType.RAW, TriggerOperatorType.GREATER_THAN_OR_EQUAL, 6,11)
        self.piston_position_2_purge = PistonPositionTrigger(TriggerOperatorType.GREATER_THAN_OR_EQUAL, 78, 0, 45)
        self.button_trigger_purge_1 = ButtonTrigger(ButtonSourceType.ENCODER_BUTTON, next_node_id = 45)
        ...
        self.pressure_controller_purge = PressureController(PressureAlgorithmType.PID_V1, 1, CurveInterpolationType.LINEAR, reference_kind = ReferenceType.TIME, reference_id = 3)
        self.piston_position_3_purge = PistonPositionTrigger(TriggerOperatorType.GREATER_THAN_OR_EQUAL, 78, 0, 45)
        self.button_trigger_purge_2 = ButtonTrigger(ButtonSourceType.ENCODER_BUTTON, next_node_id = 45)
    ...
    def water_detection_stage(self, water_detection: bool):
        ...
        self.water_detection_trigger = WaterDetectionTrigger(water_detection,self.next_node_water)
        self.button_trigger_water_detection = ButtonTrigger(ButtonSourceType.ENCODER_BUTTON, next_node_id = 15)
        ...
        self.time_trigger_water_detection = TimerTrigger(TriggerOperatorType.GREATER_THAN_OR_EQUAL, 2, 2, 9)
        self.time_trigger_water_detection_1 = TimerTrigger(TriggerOperatorType.GREATER_THAN_OR_EQUAL, 100, 12, -2)
        self.button_trigger_water_detection_1 = ButtonTrigger(ButtonSourceType.ENCODER_BUTTON, next_node_id = 15)
    ...
    def heating_stage(self,target_temperature: float, click_to_start: bool):
        ...
        self.heating_controller = TemperatureController(curve_id = 2, points = self.points_heating, reference_id = 2)
        self.position_reference_heating = PositionReferenceController(1)
        self.temperature_trigger_heating = TemperatureValueTrigger(TemperatureSourceType.WATER, TriggerOperatorType.GREATER_THAN_OR_EQUAL, target_temperature, self.next_node_heating)
        self.timer_trigger_heating = TimerTrigger(TriggerOperatorType.GREATER_THAN_OR_EQUAL, 900, 2, -2)
        self.button_trigger_heating = ButtonTrigger(ButtonSourceType.ENCODER_BUTTON, next_node_id = self.next_node_heating)
    ...
    def click_to_start_stage(self):
        ...
        self.button_trigger_click_to_start = ButtonTrigger(ButtonSourceType.ENCODER_BUTTON, next_node_id = 17)
    ...
    def retracting_stage(self):
        ...
        self.piston_position_retracting = PistonPositionTrigger(TriggerOperatorType.LESS_THAN_OR_EQUAL, -2, 1,18)
        self.button_trigger_retracting = ButtonTrigger(ButtonSourceType.ENCODER_BUTTON, next_node_id = 23)
        ...
        self.move_piston_retracting_1 = SpeedController(speed = 6, direction = DirectionType.BACKWARD)
        self.piston_speed_trigger_retracting = SpeedTrigger(TriggerOperatorType.EQUAL, 0, 21)
        self.button_trigger_retracting_1 = ButtonTrigger(ButtonSourceType.ENCODER_BUTTON, next_node_id = 23)
        ...
        self.time_trigger_retracting = TimerTrigger(TriggerOperatorType.GREATER_THAN_OR_EQUAL, 2, 4, 23)
        self.button_trigger_retracting_2 = ButtonTrigger(ButtonSourceType.ENCODER_BUTTON, next_node_id = 23)
    ...
    def closing_valve_stage(self, end_node: int):
        ...
        self.temperature_closing_valve = TemperatureController(TemperatureAlgorithmType.CYLINDER, 6, points = [0, 25], reference_id = 9)
        self.move_piston_closing_valve = SpeedController(speed = 5)
        self.time_reference_closing_valve = TimeReferenceController(1)
        self.pressure_trigger_closing_valve = PressureValueTrigger(SourceType.RAW, TriggerOperatorType.GREATER_THAN_OR_EQUAL, 0.2, end_node)
        ...
        self.closing_valve_node.add_trigger(self.pressure_trigger_closing_valve)
