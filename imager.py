...
class DiscImager:
    ...
    @staticmethod
    # Taken from stackoverflow: https://stackoverflow.com/a/76912132
    ...
    def copy_file():
        ...
        try:
            img_file_size = DiscImager._get_file_size(DiscImager.src_file)
            block_device_size = DiscImager._get_block_device_size(DiscImager.dest_file)

            if img_file_size > block_device_size:
                DiscImager.notification.message = (
                    "The emmc.img is larger than the target disc. Flashing impossible"
                )
            ...
            DiscImager.notification.message = (
                "Failed to get the image and block device size. Not going to flash!"
            )
        ...
        DiscImager.notification.message = "Starting flashing"
