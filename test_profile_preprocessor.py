...
from profile_preprocessor import ProfilePreprocessor, FormatException, UndefinedVariableException, VariableTypeException
import logging
...
class TestProfilePreprocessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.profile = {
            "variables": [
                {"name": "Pressure", "key": "pressure_1",
                    "type": "pressure", "value": 9},
            ...
            "stages": [
                {
                    ...
                    "limits": [{"type": "flow", "value": 2.1}, {"type": "pressure", "value": "$pressure_1"}]
                }
            ]
        }
    ...
    def test_successful_processing(self):
        ...
        self.assertEqual(processed_profile['stages'][0]['dynamics']['points'][0], [
                         30, 9], "Points were not processed correctly")
        self.assertEqual(processed_profile['stages'][0]['exit_triggers']
                         [0]['value'], 30, "Exit were triggers not processed correctly")
        self.assertEqual(processed_profile['stages'][0]['limits']
                         [1]['value'], 9, "Limits were not processed correctly")
