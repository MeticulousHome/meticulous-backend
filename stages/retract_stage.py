...
def get_retract_stage(parameters: json,start_node: int, end_node: int):
...
if __name__ == '__main__':
    ...
    retract_stage = get_retract_stage(json_parameters, 200, 1)
    print(json.dumps(retract_stage, indent=4))