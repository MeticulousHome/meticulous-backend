"""Initial shotDB migration

Revision ID: ed9a6ce2b461
Revises: 
Create Date: 2025-01-31 01:30:53.410857
...
def upgrade() -> None:
    ...
    if not table_exists('history'):
        op.create_table('history',
            ...
            sa.ForeignKeyConstraint(['profile_key'], ['profile.key'], ),
