...
def initialize_GPIO():
    ...
    config.consumer = 'backend'
    config.request_type = gpiod.line_request.DIRECTION_OUTPUT

    # Initialize GPIO lines
    #lcd_en = chip0.get_line(13)  
    pins["esp_en"]= chip4.get_line(9)
    pins["en"]= chip0.get_line(7)  
...
def turn_on():
    ...
    pins["esp_en"].set_value(0) ##############################
    pins["buffer_pin"].set_value(0)
    # lcd_en.set_value(0)
...
def turn_off():
    ...
    #     GPIO.output(lcd_en, 1)
    #     print("EN_PIN_HIGH = 0 por default")########Se debera determinar el entorno (raspberry o VAR-SOM-MX8M-NANO)
    pins["esp_en"].set_value(1)##############################
    pins["buffer_pin"].set_value(1)
    # lcd_en.set_value(1)
    print("EN_PIN_HIGH = 0 por default")    
